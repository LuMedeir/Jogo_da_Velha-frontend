...
<template>
  ...
  <div class="bg-cover bg-center flex flex-col items-center w-screen h-screen overflow-x-hidden overflow-y-hidden">
    <img data-test="background-image" class="absolute top-0 left-0 -z-10 w-full h-full" src="../assets/img/home-background.png">
    <img data-test="game-image" class="mt-[340px] mb-[40px] pointer-events-none" src="../assets/img/game.png"/>
    <div class="flex flex-col gap-8">
      ...
      <button @click="showTable" class="text-2xl font-semibold text-white w-64 h-14 rounded-2xl bg-green-capim hover:bg-emerald-800">Ver Historico</button>
    </div>
  </div>
</template>
